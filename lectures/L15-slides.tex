...
\quad The currently-executing process terminates (voluntarily or with an error); or\\
\quad The currently-executing process gets blocked.

\begin{center}
	\includegraphics[width=0.65\textwidth]{images/macos9.png}
\end{center}
...
System calls like \texttt{fork} may also provide good opportunities to switch from one process to another. 
